...
namespace Sphp\Core\Lib\db;

use PDO;
use Sphp\Core\Collection;
use Sphp\Core\Lib\db;
use Sphp\Core\Lib\db\exception\BindParamException;
use Sphp\Core\Lib\db\exception\DataNotFoundException;
use Sphp\Core\Lib\db\exception\DbException;
use Sphp\Core\Lib\db\exception\ModelNotFoundException;
use Sphp\Core\Lib\db\exception\PDOException;
use Sphp\Core\Exception;
use Sphp\Core\Model;
use Sphp\Core\Lib\model\Relation;
use Sphp\Core\Lib\model\relation\OneToOne;
use Sphp\Core\Paginator;
...
class Query
{
    ...
    public function getTable($name = '')
    {
        ...
        return $this->prefix . \Sphp\Core\Db::parseName($name);
    }
    ...
    public function paginate($listRows = null, $simple = false, $config = [])
    {
        ...
        /** @var Paginator $class */
        $class = false !== strpos($config['type'], '\\') ? $config['type'] : '\\Sphp\\Core\\paginator\\driver\\' . ucwords($config['type']);
