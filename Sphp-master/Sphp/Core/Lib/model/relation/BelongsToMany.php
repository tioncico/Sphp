...
namespace Sphp\Core\Lib\model\relation;
...
class BelongsToMany extends Relation
{
    ...
    {
        $class = $this->pivotName ?: '\\Sphp\\Core\\Lib\\model\\Pivot';
        $pivot = new $class($this->parent, $data, $this->middle);
        if ($pivot instanceof Pivot) {
            return $pivot;
        } else {
            throw new Exception('pivot model must extends: \Sphp\Core\Lib\model\Pivot');
        }
    }
